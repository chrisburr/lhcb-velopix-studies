...
base_dir = "/afs/cern.ch/user/m/mrwillia/cmtuser/VELO/software/planB_studies/"
...
files = [
    (join(base_dir, dataset, "BrunelOutput/Brunel_" + dataset + ".root"), (R.kBlack, 20), "TDR"),
    (join(base_dir, dataset2, "BrunelOutput/Brunel_" + dataset2 + ".root"), (R.kRed, 22), "Plan A"),
    (join(base_dir, dataset3, "BrunelOutput/Brunel_" + dataset3 + ".root"), (R.kBlue, 22), "Plan B")
]

prefix = join(base_dir, dataset3, "BrunelOutput/plots/IPRes__TDR-black_PlanA-red_PlanB-blue__zoom")
...
for (fname, colour, title) in files:
    ...
    if "long" in prefix and "long" not in dataset:
